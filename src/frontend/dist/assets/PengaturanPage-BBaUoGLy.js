import { d as createLucideIcon, r as reactExports, j as jsxRuntimeExports, c as ue, B as Button } from "./index-Cj1LDNoz.js";
...
const Stamp = createLucideIcon("stamp", __iconNode$2);
/**
 * @license lucide-react v0.511.0 - ISC
 *
 * This source code is licensed under the ISC license.
...
function UploadArea({
  ...
  const handleFile = reactExports.useCallback(
    async (file) => {
      if (!file.type.startsWith("image/")) {
        ue.error("File must be an image (PNG, JPG, etc.)");
        return;
      }
      if (file.size > 5 * 1024 * 1024) {
        ue.error("File size too large (max 5MB)");
        return;
      }
      try {
        const dataUrl = await fileToBase64(file);
        onUpload(dataUrl);
        ue.success(`${label} saved successfully`);
      } catch {
        ue.error(`Failed to save ${label.toLowerCase()}`);
      }
    },
    [label, onUpload]
  );
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { className: "overflow-hidden", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(CardHeader, { className: "pb-3 border-b border-border/60", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(CardTitle, { className: "flex items-center gap-2.5 text-base font-semibold", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "button",
        {
          ...
          children: [
            ...
            value ? /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col items-center gap-3", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "div",
                {
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-1.5 text-xs text-emerald-600 font-medium", children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx(Upload, { className: "w-8 h-8 opacity-40 group-hover:opacity-60 transition-opacity" }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm font-medium", children: "Click or drag file here" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs mt-0.5 opacity-70", children: "PNG, JPG, WebP · Max. 5MB" })
              ] })
            ] })
          ]
        }
...
function PengaturanPage() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-3xl mx-auto space-y-6", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "font-display text-2xl font-bold text-foreground", children: "Clinic Settings" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground mt-1", children: "Manage the clinic logo, digital signature, and official stamp that will appear on all printed documents." })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rounded-lg border border-primary/20 bg-primary/5 px-4 py-3 text-sm text-primary/80 flex items-start gap-2.5", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(CircleCheck, { className: "w-4 h-4 mt-0.5 shrink-0 text-primary" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: "All images are stored locally on this device and will automatically appear on Invoice, Sick Note, and Health Certificate when printed." })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-sm font-semibold text-foreground mb-3 uppercase tracking-wider", children: "Clinic Identity" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        UploadArea,
        {
          label: "Clinic Logo",
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-sm font-semibold text-foreground mb-3 uppercase tracking-wider", children: "Signature & Stamp" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground mb-4", children: "The signature and stamp will be merged together in the document footer. Use transparent PNG for the best result." }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid gap-5 sm:grid-cols-2", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          UploadArea,
          {
            ...
            icon: /* @__PURE__ */ jsxRuntimeExports.jsx(UserPen, { className: "w-4 h-4" }),
            value: signature,
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          UploadArea,
          {
            ...
            icon: /* @__PURE__ */ jsxRuntimeExports.jsx(Stamp, { className: "w-4 h-4" }),
            value: stamp,
            onUpload: setStamp,
            onClear: clearStamp,
    ...
    (signature || stamp || logo) && /* @__PURE__ */ jsxRuntimeExports.jsx(
      motion.div,
      {
        initial: { opacity: 0, y: 8 },
        animate: { opacity: 1, y: 0 },
        children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(CardHeader, { className: "pb-3 border-b border-border/60", children: /* @__PURE__ */ jsxRuntimeExports.jsx(CardTitle, { className: "text-base font-semibold", children: "Document Preview" }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs(CardContent, { className: "pt-5", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "border border-dashed border-border/60 rounded-lg p-6 bg-white", children: [
              logo && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex justify-center mb-4 pb-3 border-b-2 border-gray-300", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
                "img",
                {
                  src: logo,
                  alt: "Clinic Logo",
              ...
              (signature || stamp) && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex justify-end", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center", children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-gray-500 mt-1", children: "Examining Doctor," }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative inline-flex items-center justify-center mt-2 h-20 w-48", children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs font-semibold text-gray-800 mt-1", children: "dr. Romy Kamaluddin" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-gray-400", children: "General Practitioner" })
              ] }) })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground mt-2 text-center", children: "Preview of the header and signature area on printed documents" })
          ] })
        ] })
      }
    )
